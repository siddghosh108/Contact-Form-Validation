...
function openProjectPopup(e) {
  ...
  const elemToInsert = `
   <h3 class="title work-title">
     ...
     <a href="https://github.com/siddghosh108/Contact-Form-Validation.git" id="popup-link" class="see-live" target="_blank">
     <span>seeLive</span>
     <img src="./images/live.png" class="see-image">
     </a>
     <a href="https://github.com/siddghosh108/Contact-Form-Validation.git" id="popup-link" class="see-live">
     <span>seeSource</span>
